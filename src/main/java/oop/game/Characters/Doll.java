...
public class Doll extends Enemies{
    ...
    public void isUp() {
        super.isUp();
        img = Sprite.movingSprite(Sprite.doll_right1, Sprite.doll_right2, Sprite.doll_right3, animate, 5).getFxImage();

    }

    public void isDown() {
        super.isDown();
        img = Sprite.movingSprite(Sprite.doll_left1, Sprite.doll_left2, Sprite.doll_left3, animate, 5).getFxImage();
